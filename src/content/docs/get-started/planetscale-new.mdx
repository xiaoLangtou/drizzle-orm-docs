...
<Callout title='提示'>
要获取通过 `database-js` 驱动连接所需的所有环境变量，你可以查看 [PlanetScale 文档](https://planetscale.com/docs/tutorials/planetscale-serverless-driver-node-example#use-the-sample-repository)
</Callout>
